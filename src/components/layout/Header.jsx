...
const Header = () => {
  ...
  return (
    <motion.nav
            ...
            initial="initial"
            animate="animate"
    className={`bg-opacity-50 flex fixed transition-shadow duration-300 ease-in-out ${scroll ? 'shadow-md' : ''} justify-between items-center backdrop-blur top-0 right-0 left-0 z-10 h-32 bg-gray-100 `}>
